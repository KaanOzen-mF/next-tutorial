...
export default function CommunityPage() {
  return (
    <>
      <header className="gap-24 mt-24 mb-20 mx-auto w-11/12 max-w-6xl text-[#ddd6cb] text-2xl text-center">
        <h1>
          One shared passion:{" "}
      ...
      <main className="w-11/12 max-w-xl my-0 mx-auto text-center">
        <h2 className="text-xl mb-12 text-[#ddd6cb]">Community Perks</h2>
        <ul className="p-0 mx-12 my-0">
          <li className="flex flex-col items-center gap-8">
            ...
            />
            <p className="text-[#ddd6cb] text-2xl font-bold m-0">
